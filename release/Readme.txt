...
This is a WIP UI replacement for Morrowind, eventually intending to completely replace all UI elements in the game. While at this early stage, I have packaged everything in a modular way so you can pick and choose which aspects of UI Remastered you'd like to use.
...
Continue adds a 'Continue' button to load your last save. I may include this as an optional addon in future.
Morrowind Script Extender﻿ adds a 'Mod Config' option to manage mwse mods.
...
The HUD Elements contain support for MGE XE - HUD Mods﻿ Time display mod, replacing the letters and numbers used.
...
MGE XE - HUD Mods﻿ from optional files, you'll only need the ownership indicator plugin. or
Ownership Indicator﻿ if you want a plugin-free version, which I may include as an optional script in this package in future.
...
Magicka Expanded﻿ adds various new spells.
UI Expansion adds filters to the menu with their own icons.
...
Both packs support Tamriel Data and any of the mods that use it as a base.
...
Ownership Indicator﻿
To get the ownership indicator working!
...
Supported Mods
Currently, the following mods have UI elements supported in this mod, make sure to install them before this;
Continue (main menu button)
Morrowind Script Extender﻿ (main menu button & logo)
MGE XE - HUD Mods﻿ (ownership indicator and time display)
Ownership Indicator﻿ (plugin free alternative)
Tamriel Data (all item icons)
UI Expansion (all filter icons)
Magicka Expanded﻿ (all magic icons)
